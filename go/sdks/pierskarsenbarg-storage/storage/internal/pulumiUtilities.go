...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-storage/sdk(/v\\d+)?")
...
func PkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	...
	defaults = append(defaults, pulumi.PluginDownloadURL("git://github.com/pierskarsenbarg/storage"))
	version := semver.MustParse("0.0.0-x2762204eaf5970252cd01b1d38107a11b515b0c3")
